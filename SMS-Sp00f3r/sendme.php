...
if ($Passw == "123"){
	...
	echo '<br><a href="https://sms.unknownclub.net/" class="btn btn-info" role="button">Back to SMS sender</a>';
	echo "</html>";

}else{
	echo "<html>";
	echo "<b>Invalid Password</b>";
	echo '<br><a href="https://sms.unknownclub.net/" class="btn btn-danger" role="button">Back to SMS sender</a>';
	echo "</html>";
}
